...
const Detailproducts = () => {
  ...
  const subtotal = chiTietDonhang.reduce(
    (sum, item) => sum + item.so_luong * item.gia,
    0
  );
                ...
                <div className="summary-details">
                  ...
                  {donhangInfo?.giam_gia_tien && (
                    <div className="summary-row">
                      ...
                      <span className="summary-value">
                        - {formatPrice(donhangInfo.giam_gia_tien)}
                      </span>
                    </div>
                  )}
                  {donhangInfo?.phi_van_chuyen && (
                    <div className="summary-row">
                      ...
                      <span className="summary-value">
                        {formatPrice(donhangInfo.phi_van_chuyen)}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="summary-total">
                    ...
                    <span className="total-value">
                      {formatPrice(donhangInfo?.tong_tien || subtotal)}
                    </span>
                  </div>
                </div>
              </Card.Body>
                  ...
                  <div className="payment-info">
                    <div className="payment-method">
                      ...
                      <div className="payment-value">
                        {getPaymentMethodDisplay(donhangInfo.paymentMethod)}
                      </div>
                    </div>
                    ...
                    <div className="payment-status">
                      ...
                      {donhangInfo.trang_thai?.toLowerCase() ===
                        "chờ xử lý" && (
                        <Button
                          variant="danger"
                          size="sm"
