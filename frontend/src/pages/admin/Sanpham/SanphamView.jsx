...
const SanphamView = ({ open, onClose, sanphamId }) => {
  ...
  useEffect(() => {
    if (open && sanphamId) {
      setLoading(true);
      axios
        .get(`${API_BASE}sanpham/${sanphamId}`)
        .then((res) => {
                        ...
                        {sanpham.hinh_anh && (
                          <Avatar
                            ...
                            sx={{
                              ...
                              border: "3px solid",
                              borderColor:
                                selectedImage === getImageUrl(sanpham.hinh_anh)
                                  ? "primary.main"
                                  : "grey.300",
                              transition: "all 0.2s",
                              "&:hover": {
                            ...
                            onClick={() =>
                              setSelectedImage(getImageUrl(sanpham.hinh_anh))
                            }
                          />
                        )}
                        {sanpham.images?.map((imgObj, idx) => (
                          <Avatar
                            ...
                            sx={{
                              ...
                              border: "3px solid",
                              borderColor:
                                selectedImage === getImageUrl(imgObj.image_path)
                                  ? "primary.main"
                                  : "grey.300",
                              transition: "all 0.2s",
                              "&:hover": {
                            ...
                            onClick={() =>
                              setSelectedImage(getImageUrl(imgObj.image_path))
                            }
                          />
                        ))}
                      </Stack>
                            ...
                            >
                              ...
                              <Stack spacing={1}>
                                ...
                                >
                                  ...
                                  <Typography variant="body2" fontWeight="600">
                                    {variant.gia
                                      ? `${parseInt(variant.gia).toLocaleString(
                                          "vi-VN"
                                        )} ₫`
                                      : "N/A"}
                                  </Typography>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} sm={6} md={4}>
                        <InfoCard
                          ...
                          label="Danh mục"
                          value={
                            danhMucMap[sanpham.danh_muc_id] || "Chưa phân loại"
                          }
                          color="warning"
                        />
                      </Grid>
